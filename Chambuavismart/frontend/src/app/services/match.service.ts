...
export interface TeamBreakdownDto { total: number; wins: number; draws: number; losses: number; btts: number; over25: number; over15: number; longestStreakType?: string; longestStreakCount?: number; }
