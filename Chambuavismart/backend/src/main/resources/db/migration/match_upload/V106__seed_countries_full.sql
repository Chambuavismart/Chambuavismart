-- Ensure countries table exists before seeding (idempotent)
...
-- Seed full ISO-3166-1 alpha-2 country list (name in English)
-- Safe for re-run: ON DUPLICATE KEY UPDATE
...
('CV','Cabo Verde'),('KY','Cayman Islands'),('CF','Central African Republic'),('TD','Chad'),('CL','Chile'),
